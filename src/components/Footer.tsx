    ...
    <footer className="bg-[#143621] text-white">
      <div className="container mx-auto px-4 lg:px-8 py-16">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          {/* Brand */}
          <div>
            <span className="font-serif text-2xl font-semibold">Zohar Energy</span>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-sans text-base font-semibold mb-4 text-white">Quick Links</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="font-sans text-base font-semibold mb-4 text-white">Services</h3>
            <div className="flex flex-col gap-2 text-sm text-white/70">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-6">
              <a href="https://wa.me/2348134978154" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#D4AF37] hover:text-[#143621] transition-all" aria-label="WhatsApp">
                <FaWhatsapp className="w-4 h-4" />
              </a>
              <a href="https://instagram.com/zohar-energy" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#D4AF37] hover:text-[#143621] transition-all" aria-label="Instagram">
                <FaInstagram className="w-4 h-4" />
              </a>
              <a href="https://facebook.com/zoharenergy01" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#D4AF37] hover:text-[#143621] transition-all" aria-label="Facebook">
        ...
        <div className="mt-12 border-t border-white/10 pt-6 text-center text-xs text-white/50">
          © 2026 Zohar Energy. All rights reserved.
        </div>
      </div>
    </footer>
  );
